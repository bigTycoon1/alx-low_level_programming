...
/**
 * close_elf - ELF file to be close 
 * @elf: file descriptor of the ELF file.
 *
 * Description: incase the file can't be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * ELF header file
 * @argc: The number of arguments to be count.
 * @argv: pointer to arguments vector.
 *
 * Return: 0 on success.
 *
 * Description: If the file is noto on ELF File, or
